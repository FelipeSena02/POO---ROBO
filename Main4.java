...
public class Main4 {
    public static void main(String[] args) {
        ...
        Robo roboInteligente = new RoboInteligente("Vermelho");
        ...
        while ((!alimentoNormalEncontrado || !alimentoInteligenteEncontrado) &&
            ...
            try {
                ...
                if (!alimentoNormalEncontrado && roboNormal.getAtivo()) {
                	String direcaoNormal = "'";
                	roboNormal.setMovimentoAnterior(direcaoNormal);
                    direcaoNormal = direcoes[random.nextInt(direcoes.length)];
                ...
                if (!alimentoInteligenteEncontrado && roboInteligente.getAtivo()) {
                	String direcaoInteligente = "'";
                	roboInteligente.setMovimentoAnterior(direcaoInteligente);
                    direcaoInteligente = direcoes[random.nextInt(direcoes.length)];
